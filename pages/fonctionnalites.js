...
export default function Fonctionnalites() {
  return (
    <Layout>
      <div id='corpo' className="container mx-auto min-h-screen p-2 bg-gray-50">
          ...
          <div className="grid md:grid-cols-3">
            ...
            <div className="px-4 md:flex justify-end md: items-center text-center">
              <div className="px-2 md:px-10 py-6 md:py-12 rounded-md">
                ...
                <div className='rounded-md shadow-md bg-white p-6 sm:rounded-nono sm: shadow-none sm:bg-transparent'>
